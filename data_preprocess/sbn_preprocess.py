...
if __name__ == "__main__":
    ...
    outfile1 = open(args.input_src+ ".{0}.{1}".format(args.text_type, args.if_anony), 'w')
    if args.if_anony == 'anony':
        outfile2 = open(args.input_tgt + ".{0}".format(args.if_anony), 'w')
    ...
    if args.replace:
        ...
        file_to_replace = open(args.input_src + '.graph' + ".{0}".format(args.if_anony), 'r') 
        # ----------------------------------
