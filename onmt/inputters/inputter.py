...
#--------------------------------
from onmt.inputters.sbn_dataset_bos1 import SBNDatasetBos1
from onmt.inputters.sbn_dataset_bos2 import SBNDatasetBos2
from onmt.inputters.sbn_dataset_bos3 import SBNDatasetBos3
from onmt.inputters.sbn_dataset_self import SBNDatasetSelf
from onmt.inputters.sbn_dataset_edge import SBNDatasetEdge
#--------------------------------
...
def get_fields(data_type, n_src_features, n_tgt_features):
    ...
    #--------------------------------
    elif data_type == 'SBNbos1':
        return SBNDatasetBos1.get_fields(n_src_features, n_tgt_features)
    elif data_type == 'SBNbos2':
        return SBNDatasetBos2.get_fields(n_src_features, n_tgt_features)
    elif data_type == 'SBNbos3':
        return SBNDatasetBos3.get_fields(n_src_features, n_tgt_features)
    elif data_type == 'SBNedge':
        return SBNDatasetEdge.get_fields(n_src_features, n_tgt_features)
    elif data_type == 'SBNself':
        return SBNDatasetSelf.get_fields(n_src_features, n_tgt_features)
    # --------------------------------
    else:
...
def get_num_features(data_type, corpus_file, side):
    ...
    # --------------------------------
        ...
        return SBNDatasetBos1.get_num_features(corpus_file, side)
    elif data_type == 'SBNbos2':
        return SBNDatasetBos2.get_num_features(corpus_file, side)
    elif data_type == 'SBNbos3':
        return SBNDatasetBos3.get_num_features(corpus_file, side)
    elif data_type == 'SBNedge':
        return SBNDatasetEdge.get_num_features(corpus_file, side)
    elif data_type == 'SBNself':
        return SBNDatasetSelf.get_num_features(corpus_file, side)
    # --------------------------------
    else:
        raise ValueError("Data type not implemented")
...
def build_dataset(fields, data_type, src_data_iter=None, src_path=None,
    ...
    def _make_examples_nfeats_tpl(data_type, src_data_iter, src_path, src_dir,
        ...
        #----------------------------------------
            ...
            src_examples_iter, num_src_feats = \
                SBNDatasetBos1.make_SBN_examples_nfeats_tpl(
                    src_data_iter, src_path, src_seq_length_trunc,
                    "src", reentrancies)
        elif data_type == 'SBNbos2':
            src_examples_iter, num_src_feats = \
                SBNDatasetBos2.make_SBN_examples_nfeats_tpl(
                    src_data_iter, src_path, src_seq_length_trunc,
                    "src", reentrancies)
        elif data_type == 'SBNbos3':
            src_examples_iter, num_src_feats = \
                SBNDatasetBos3.make_SBN_examples_nfeats_tpl(
                    src_data_iter, src_path, src_seq_length_trunc,
                    "src", reentrancies)
        elif data_type == 'SBNedge':
            src_examples_iter, num_src_feats = \
                SBNDatasetEdge.make_SBN_examples_nfeats_tpl(
                    src_data_iter, src_path, src_seq_length_trunc,
                    "src", reentrancies)
        elif data_type == 'SBNself':
            src_examples_iter, num_src_feats = \
                SBNDatasetSelf.make_SBN_examples_nfeats_tpl(
                    src_data_iter, src_path, src_seq_length_trunc,
                    "src", reentrancies)
        #---------------------------------------
    ...
    #---------------------------
        ...
        dataset = SBNDatasetBos1(fields, src_examples_iter, tgt_examples_iter,
                              num_src_feats, num_tgt_feats,
                              src_seq_length=src_seq_length,
                              tgt_seq_length=tgt_seq_length,
                              dynamic_dict=dynamic_dict,
        ...
        dataset = SBNDatasetBos2(fields, src_examples_iter, tgt_examples_iter,
                             num_src_feats, num_tgt_feats,
                             src_seq_length=src_seq_length,
                             tgt_seq_length=tgt_seq_length,
                             dynamic_dict=dynamic_dict,
        ...
        dataset = SBNDatasetBos3(fields, src_examples_iter, tgt_examples_iter,
                             num_src_feats, num_tgt_feats,
                             src_seq_length=src_seq_length,
                             tgt_seq_length=tgt_seq_length,
                             dynamic_dict=dynamic_dict,
        ...
        dataset = SBNDatasetEdge(fields, src_examples_iter, tgt_examples_iter,
                             num_src_feats, num_tgt_feats,
                             src_seq_length=src_seq_length,
                             tgt_seq_length=tgt_seq_length,
                             dynamic_dict=dynamic_dict,
        ...
        dataset = SBNDatasetSelf(fields, src_examples_iter, tgt_examples_iter,
                             num_src_feats, num_tgt_feats,
                             src_seq_length=src_seq_length,
                             tgt_seq_length=tgt_seq_length,
                             dynamic_dict=dynamic_dict,
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    if data_type == 'text' or 'SBN' in data_type:
...
class SBNBatch:
    ...
    def __init__(self, data, dataset, device, train):
        ...
        for example in data:
            ...
            #print(example.src_graph.matrix.shape)
...
class SBNIterator(torchtext.data.Iterator):
