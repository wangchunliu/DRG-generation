...
class Translator(object):
        ...
        for batch in data_iter:
            ...
            for trans in translations:
                ...
                if attn_debug:
                    ...
                    if self.data_type == 'text' or 'SBN' in self.data_type:
                        srcs = trans.src_raw
                    else:
    ...
    def _fast_translate_batch(self,
        ...
        assert data.data_type == 'text' or 'SBN' in data.data_type
    ...
    def _translate_batch(self, batch, data):
        ...
        src_map = rvar(batch.src_map.data) \
            if (data_type in ['text'] or 'SBN' in data_type)  and self.copy_attn else None
    ...
    def _run_target(self, batch, data):
        data_type = data.data_type
        if data_type == 'text' or data_type in data_type:
            _, src_lengths = batch.src
        elif data_type == 'audio':
            src_lengths = batch.src_lengths
        else:
