...
from onmt.encoders.gat_encoder import GATEncoder
...
def build_encoder(opt, embeddings):
    ...
    elif opt.encoder_type == "rnngat" or opt.encoder_type == "gat":
        opt.brnn = True if opt.encoder_type == "rnngat" else False
        return GATEncoder(opt.rnn_type, opt.brnn, opt.enc_layers,
                          opt.rnn_size, opt.dropout, embeddings,
                          opt.bridge, opt.gcn_dropout, 
                          opt.gcn_edge_dropout, opt.n_gcn_layers, 
                          opt.activation, opt.highway)    
    elif opt.encoder_type == "rnnggnn" or opt.encoder_type == "ggnn":
        opt.brnn = True if opt.encoder_type == "rnnggnn" else False
        return GGNNEncoder(opt.rnn_type, opt.brnn, opt.enc_layers,
                          opt.rnn_size, opt.dropout, embeddings,
                          opt.bridge, opt.gcn_dropout, 
                          opt.gcn_edge_dropout, opt.n_gcn_layers, 
                          opt.activation, opt.highway)    
